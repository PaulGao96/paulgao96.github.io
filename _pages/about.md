...
I have broad interest in networking and systems, including **Digital Twin Networks**, **Programmable Networks**, **Intelligent Networks**, etc. Currently, I am focusing on constructing digital twins of networks, including DCNs, Internet.



Selected publications
======
Fei Gui, **Kaihui Gao***, Li Chen, Dan Li, Vincent Liu, et al. Accelerating Design Space Exploration for LLM Training Systems with Multi-experiment Parallel Simulation. [USENIX NSDI'2025](https://www.usenix.org/conference/nsdi25) (CCF A, TH-CPL A) (*corresponding author). Open sourced: [Multiverse's GitHub](https://github.com/NASP-THU/multiverse).
